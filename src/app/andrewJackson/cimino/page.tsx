...
// import ciminoImg from './img/cimino.webp';
...
const CiminoProcedure: React.FC = () => {
        ...
        <Card>
            <CardContent className='p-5'>
                ...
                {/* <CardContent className='mb-4 flex justify-center w-[690px] h-[390px]'>
                    <Image src={ciminoImg} alt="cimino" className="hover:scale-150 duration-700 w-96 -ml-11" />
                </CardContent> */}
                <div className="mb-4">
...
export default CiminoProcedure;
