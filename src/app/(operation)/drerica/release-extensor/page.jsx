    ...
    return (
        ...
        <div className="text-start ">
          ...
          <h2 className="text-2xl font-semibold">Tim Operasi:</h2> */}
            ...
            {/* <div className='mb-4 flex flex-1 gap-20 justify-center'>
            <img src={elbow1} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
            <img src={elbow2} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
          </div> */}
            {/* <div className="mb-4">
          ...
          <ul className="flex flex-wrap gap-4 justify-center">
            ...
            <div className='mb-4 flex flex-1 gap-20 justify-center'>
                <Image src={releaseExtensore} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
                <Image src={releaseExtensore1} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
            </div>
...
export default ReleaseExtensorCarpiRadialis