// KraniotomiDekompresi.tsx
"use client";

import { useState, useEffect } from 'react';
import data from './data.json';
import Card from "@/components/card";
import { LaporanOperasi } from './types';

const KraniotomiDekompresi = () => {
    const [laporanOperasi, setLaporanOperasi] = useState<LaporanOperasi | null>(null);

    useEffect(() => {
        setLaporanOperasi(data.laporanOperasi as LaporanOperasi);
    }, []);
            ...
            <div className="container mx-auto p-4 text-left">
                ...
                <div className="mb-4">
                    ...
                    <ul className="flex flex-wrap gap-4 mb-4 justify-center">
                        {laporanOperasi.persiapanAlatKesehatan.map((item, index) => (
                ...
                <div className="mb-4">
                    ...
                    <ul className="flex flex-wrap gap-4 justify-center">
                        {laporanOperasi.persiapanInstrument.map((item, index) => (
                            <li key={index} className='bg-gray-100 p-2 border rounded-xl w-1/3 hover:bg-green-400 xs:custom-list-item'>{item}</li>
                        ))}
                    </ul>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <ul className="flex flex-wrap gap-4 justify-center">
                        {laporanOperasi.penataanInstrumentMejaOperasi.map((item, index) => (
                ...
                <div className="mb-4">
                    ...
                    {laporanOperasi.teknikOperasi.map((item, index) => (
                ...
                <div className='mb-4'>
                    ...
                    <ul className='list-disc ml-4 mb-3 p-3'>
                        {laporanOperasi.ringkasanOperasi.map((item, index) => (
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside">
                        {laporanOperasi.diagnosaKeperawatan.SDKI.map((item, index) => (
                    ...
                    {laporanOperasi.diagnosaKeperawatan.SIKI && (
                        <div className="ml-4">
                            ...
                            <ul className="list-disc list-inside">
                                {laporanOperasi.diagnosaKeperawatan.SIKI.pemantauanTekananIntrakranial.observasi.map((item, index) => (
                                    <li key={index}>{item}</li>
                                ))}
                            </ul>
                            <h5 className="font-semibold">Terapeutik:</h5>
                            <ul className="list-disc list-inside">
                                {laporanOperasi.diagnosaKeperawatan.SIKI.pemantauanTekananIntrakranial.terapeutik.map((item, index) => (
                                    <li key={index}>{item}</li>
                                ))}
                            </ul>
                            <h5 className="font-semibold">Edukasi:</h5>
                            <ul className="list-disc list-inside">
                                {laporanOperasi.diagnosaKeperawatan.SIKI.pemantauanTekananIntrakranial.edukasi.map((item, index) => (
                                    <li key={index}>{item}</li>
                                ))}
                            </ul>
                        </div>
